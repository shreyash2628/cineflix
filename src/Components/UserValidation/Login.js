...
const Login = () => {
  return (
    <div className='flex items-center justify-center h-screen sm:flex sm:items-center sm:justify-center sm:h-screen md:flex md:items-center md:justify-center md:h-screen lg:flex lg:items-center lg:justify-center lg:h-screen'>
